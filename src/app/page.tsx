    ...
    <div className="justify-center max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
      ...
      <div className="flex items-center justify-between mb-4 sm:mb-6 mt-12 sm:mt-16">
        <div className="flex items-center flex-1">
          ...
          <div className="ml-3 sm:ml-4 h-px flex-grow bg-border opacity-20" />
        </div>
        <Link
          href="/blog"
          className="ml-3 sm:ml-4 text-xs text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1 group"
        >
          View All
      ...
      <div className="space-y-3 sm:space-y-4 mb-12 sm:mb-16">
        {blogPosts.map((post, index) => (
          <Link
            ...
            className="block"
          >
            <div className="flex flex-col md:flex-row md:items-center justify-between group p-3 sm:p-4 -mx-3 sm:-mx-4 rounded-lg hover:bg-muted/20 transition-colors cursor-pointer">
              ...
              <div className="flex items-center space-x-3 sm:space-x-4 mt-2 md:mt-0">
                ...
                <span className="text-xs sm:text-sm font-mono text-muted-foreground/20">
                  {post.date}
                </span>
              </div>
            </div>
      ...
      <div id="projects" className="flex items-center justify-between mb-4 sm:mb-6">
        <div className="flex items-center flex-1">
          <h2 className="text-xs uppercase tracking-[0.3em] text-muted-foreground/60 font-bold">
            Pinned Projects
          </h2>
